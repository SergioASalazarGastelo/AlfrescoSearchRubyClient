...
# Unit tests for SwaggerClient::RequestFacetField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestFacetField' do
  before do
    # run before each test
    @instance = SwaggerClient::RequestFacetField.new
  end
  ...
  describe 'test an instance of RequestFacetField' do
    it 'should create an instance of RequestFacetField' do
      expect(@instance).to be_instance_of(SwaggerClient::RequestFacetField)
    end
  end
