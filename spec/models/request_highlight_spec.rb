...
# Unit tests for SwaggerClient::RequestHighlight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestHighlight' do
  before do
    # run before each test
    @instance = SwaggerClient::RequestHighlight.new
  end
  ...
  describe 'test an instance of RequestHighlight' do
    it 'should create an instance of RequestHighlight' do
      expect(@instance).to be_instance_of(SwaggerClient::RequestHighlight)
    end
  end
