...
# Unit tests for SwaggerClient::RequestFacetIntervals
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestFacetIntervals' do
  before do
    # run before each test
    @instance = SwaggerClient::RequestFacetIntervals.new
  end
  ...
  describe 'test an instance of RequestFacetIntervals' do
    it 'should create an instance of RequestFacetIntervals' do
      expect(@instance).to be_instance_of(SwaggerClient::RequestFacetIntervals)
    end
  end
