...
# Unit tests for SwaggerClient::RequestFacetFields
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestFacetFields' do
  before do
    # run before each test
    @instance = SwaggerClient::RequestFacetFields.new
  end
  ...
  describe 'test an instance of RequestFacetFields' do
    it 'should create an instance of RequestFacetFields' do
      expect(@instance).to be_instance_of(SwaggerClient::RequestFacetFields)
    end
  end
