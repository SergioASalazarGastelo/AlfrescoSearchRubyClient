...
module SwaggerClient
  ...
  class GenericBucket
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bucketInfo')
        self.bucket_info = attributes[:'bucketInfo']
      end
    end
    ...
    def hash
      [label, filter_query, display, metrics, facets, bucket_info].hash
    end
