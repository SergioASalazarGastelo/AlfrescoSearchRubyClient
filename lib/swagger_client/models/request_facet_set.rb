...
module SwaggerClient
  ...
  class RequestFacetSet
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'startInclusive')
        self.start_inclusive = attributes[:'startInclusive']
      else
        self.start_inclusive = true
      end

      if attributes.has_key?(:'endInclusive')
        self.end_inclusive = attributes[:'endInclusive']
      else
    ...
    def hash
      [label, start, _end, start_inclusive, end_inclusive].hash
    end
