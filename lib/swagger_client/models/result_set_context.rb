...
module SwaggerClient
  ...
  class ResultSetContext
    ...
    def self.swagger_types
      {
        ...
        :'facet_queries' => :'Array<Object>',
        :'facets_fields' => :'Array<ResultBuckets>',
        :'facets' => :'Array<GenericFacetResponse>',
        :'spellcheck' => :'Array<Object>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consistency')
      ...
      if attributes.has_key?(:'facetQueries')
        if (value = attributes[:'facetQueries']).is_a?(Array)
          self.facet_queries = value
        end
      end

      if attributes.has_key?(:'facetsFields')
        if (value = attributes[:'facetsFields']).is_a?(Array)
          self.facets_fields = value
        end
      end
      ...
      if attributes.has_key?(:'spellcheck')
        if (value = attributes[:'spellcheck']).is_a?(Array)
    ...
    def hash
      [consistency, request, facet_queries, facets_fields, facets, spellcheck].hash
    end
